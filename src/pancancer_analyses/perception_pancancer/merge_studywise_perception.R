...
write_matrix_dir(
    mat = full_mat,
    dir = "./perception/full_mat_perception",
    overwrite = TRUE
    )
...
mat <- open_matrix_dir(dir = "./perception/full_mat_perception")
...
write_tsv(
    ...
    file = "./perception/metadata_with_clinical.tsv"
    )
