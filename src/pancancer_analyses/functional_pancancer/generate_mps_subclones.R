...
# mps <- c(
#   "MP1", "MP8", "MP14", "MP3", "MP13", "MP2", "MP9", "MP4", "MP10", "MP12",
#   "MP5", "MP6", "MP7", "MP11"
# )
...
draw(heat, 
     ...
     annotation_legend_list = list(tumor_site_legend, study_legend))
dev.off()
...
pairwise_matrix <- matrix(pairwise_intersections,
  nrow = length(mp_list),
